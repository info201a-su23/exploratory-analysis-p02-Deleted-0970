...
Between the years 1750 and 2015, the average global temperature has experienced a significant change, with an average increase of approximately `r avg_global_temp_change`°C. In 1752, the minimum average temperature was recorded at `r lowest_global_temp`°C, while in 2015, the maximum average temperature reached `r highest_global_temp`°C. A notable temperature of `r median_global_temp`°C was observed in 1906 as the median average temperature during this period. Finally, we can calculate the mean of these temperatures:
